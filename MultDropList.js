...
new MultDrop({
    selectorId: 'multDrop222',
    width: "200px",
    height: "100px",
    name: 'ddd',
    data: $('#multDropData').val(),
    selectedData: $('#multDropSelected').val(),
    dataFormate: function(val) {
        return val.split('|');
    },
    selectedDataFormate: function(val) {
    ...
    afterCheck: function(MultDrop) {
        console.log(1)
        console.log(MultDrop.VALUE)
    }
});

var aa = new MultDrop({
    selectorId: 'multDrop333',
    width: "200px",
    height: "auto",
    data: $('#multDropData1').val(),
    selectAll: 'false',
    selectedData: $('#multDropSelected1').val(),
    dataFormate: function(val) {
